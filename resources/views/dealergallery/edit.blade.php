...
<div class="container-fluid p-3">
    ...
    <div class="col-md-12">
        <div class="card rounded-0">
                <div class="card-body">
                    <form method="POST" id="AddBreadForm" enctype="multipart/form-data" action="{!! route('Ripple::dealergallery.update',['id' => $carsgallery->id]) !!}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select id="approved_cars_makers" name="gallery[car]"  class="custom-select syncRef">
                                    ...
                                    @forelse($cars as $car)
                                    <option value="{{ $car->id}}" {!! $car->id == $carsgallery->car ? 'selected' : '' !!}>{{ $car->name}}</option>
                                    @empty
                                    @endforelse                            
                            </select>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="card">
                                        ...
                                        <div class="row">
                                                <div class="col-5">
                                                    <div class="clearfix" id="preview-image"> 
                                                        <img width="auto" height="150" class="img-responsive" src="{!! url(Storage::url( $carsgallery->media)) !!}" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gallery[view_order]"  value="{{$carsgallery->view_order}}" class="form-control">
                                </div>
                            </form>
                        </div>
