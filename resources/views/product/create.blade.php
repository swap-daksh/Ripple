            ...
            <div class="card-body">
                <form class="needs-validation" enctype="multipart/form-data" novalidate="" method="post" action="{!! route('Ripple::products.store') !!}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ripple_text_editor" rows="12" name="product[short_description]"></textarea>
                                    <div class="invalid-feedback">
                                    Valid first name is required.
                                    </div>
                                </div>
                                ...
                                <div class="card rounded-0 mt-3">
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="date" class="form-control" name="product[sale_start]" value="{{ date('Y-m-d') }}">
                                        </div>
                                        <div class="form-group col-6">
                                            <label>Sale End</label>
                                            <input type="date" class="form-control" name="product[sale_end]" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 text-center p-0">
                            <hr>
                            <button type="submit" class="btn w-50 btn-primary"><i class="fa fa-save"></i>   Publish Product</button>
                        </div>
                </form>
            </div>
        </div>
