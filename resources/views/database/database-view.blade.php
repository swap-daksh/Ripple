...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="tab-content vertical-tab-content" style="margin-bottom: 15px;">
            <div class="tab-pane fade in clearfix active" role="tabpanel" id="create-tables"  ng-app="createTable" ng-controller="NewTableController" aria-labelledby="create-tables">
                <div class="block block-default" data-example-id="togglable-tabs"> 
                    <div class="block-heading"><strong style="text-transform: uppercase;">Create Table</strong></div>
                </div>
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-6">
                        <input type="text" name="table" placeholder="Table Name" id="" class="form-control input-sm">
                    </div>
                    <div class="col-md-2">
            ...
            <div class="tab-pane fade in clearfix " role="tabpanel" id="list-tables" aria-labelledby="list-tables">
                <div class="block block-default" data-example-id="togglable-tabs"> 
...
<script type="text/javascript">
    ...
    createDatabase.controller('NewTableController', ['$scope', function ($scope) {
            ...
            $scope.defaultColumn = function () {
                $scope.insertColumn = {name: '', type: 'varchar', length: 255, index: null, default: null, unsigned: false, notnull: false, autoincrement: false};
            };
