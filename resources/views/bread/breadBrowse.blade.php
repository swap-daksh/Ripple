        ...
        <table class="table table-striped table-borderless table-header-bg option-wrappers" id="option-wrappers" style="margin-bottom: 0px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endforeach
                    <td>
                    <a href="{!! route('Ripple::adminBreadEdit', ['slug'=>$bread->slug, 'id'=>$record->id]) !!}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="javascript:;" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Trash</a>
                    </td>
                </tr>
                @empty
                <tr>
