...
<div class="container-fluid p-3">
    ...
    <div class="col-md-12">
        <div class="card rounded-0">
                <div class="card-body">
                    <form method="POST" id="AddBreadForm" enctype="multipart/form-data" action="{!! route('Ripple::dealer.store') !!}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dealer[name]" class="form-control">
                                </div> 
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input type="checkbox" name="dealer[sold]" value="1" id="sold_custom_checkbox" class="custom-control-input"> 
                                            <label for="sold_custom_checkbox" class="custom-control-label">Check/Uncheck</label>
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label for="">COLOR</label> 
                                        <input type="text" name="dealer[color]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">VIDEO</label> 
                                        <input type="text" name="dealer[video]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">BASE PRICE</label> 
                                        <input type="text" name="dealer[base_price]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">MID PRICE</label> 
                                        <input type="text" name="dealer[mid_price]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">TOP PRICE</label> 
                                        <input type="text" name="dealer[top_price]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">WARRANTY</label> 
                                        <input type="text" name="dealer[warranty]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">ACCELERATION</label> 
                                        <input type="text" name="dealer[acceleration]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">SPEED</label> 
                                        <input type="text" name="dealer[speed]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">ENGINE</label> 
                                        <input type="text" name="dealer[engine]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">HORSEPOWER</label> 
                                        <input type="text" name="dealer[horsepower]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">CYLINDERS</label>
                                        <input type="text" name="dealer[cylinders]" class="form-control">
                                    </div> 
                                    <div class="form-group">
                                        <label for="">SPECIAL FEATURE</label> 
                                        <input type="text" name="dealer[special_feature]" class="form-control">
                                    </div>
                            </form>
                        </div>
