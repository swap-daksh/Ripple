                                ...
                                <div class="" id="accordion">
                                    ...
                                    <div class="card rounded-0 mb-1">
                                        <div class="card-header rounded-0 p-0" id="{!! $setting->key !!}_heading">
                                            <h5 class="mb-0">
                                                <button style="text-decoration: none;" class="btn btn-link" type="button" data-toggle="collapse" data-target="#{!! $loop->index !!}" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-body">
                                    <form method="post" action="" id="add_new_setting">
                                        ...
                                        <div class="form-group clearfix">
                                            <select required name="setting-type" id="setting-type" data-id='setting-type' class="custom-select setting-type">
