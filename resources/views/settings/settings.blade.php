...
<div class="page-header" style="margin: 0px;border-bottom: 1px solid gray;">
    <h1  style="margin: 0px;">Settings<small> Setting</small> <button data-toggle="modal" data-target="#modal-large" type="button" class="btn btn-success btn-sm">Create Setting</button></h1>
</div>
<div class="panel ">
    <form class="form-horizontal push-10-t push-10" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">
                {!! strtoupper($setting->display_name) !!} <code>Voyager::setting('title')</code>
...
{{-- Page Content --}}
<!-- Modal -->
<div class="modal fade" id="modal-large" tabindex="-1" role="dialog" aria-labelledby="modal-large">
